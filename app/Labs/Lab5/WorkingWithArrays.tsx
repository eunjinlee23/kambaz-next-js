...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
        ...
        <h3>Updating an Item in an Arrays</h3>
        ...
        <h3>Updating Completed status of an Item</h3>
        <FormControl defaultValue={todo.id} className="w-25 me-2"
            onChange={(e) => setTodo({ ...todo, id: e.target.value})} />    
        <Form.Check label="completed" name="assignment-completed-false" defaultChecked={todo.completed} type="switch"
